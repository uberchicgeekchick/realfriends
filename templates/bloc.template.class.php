<?php
	/*
		...
		All software distributed under the RPL is provided strictly on an "AS
    		...
    		the RPL.
	*/
	namespace realFriends::blocs;

	require_once("{$GLOBALS['rFds_realFriends']['path']}/objects/modules/00-core.class.inc.php" );

	class new_bloc extends realFriends::core::bloc {
