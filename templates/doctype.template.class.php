<?php
	...
	*/
	...
	require_once("{$GLOBALS['rFds_realFriends']['path']}/objects/doctypes/00-core.class.php" );

	class new_doctype extends realFriends::core::doctype {
