<?php
	/*
		...
		All software distributed under the RPL is provided strictly on an "AS
    		...
    		the RPL.
	*/
	namespace realFriends::view;

	require_once("{$GLOBALS['rFds_realFriends']['path']}/objects/views/00-core.class.php" );

	class new_view extends realFriends::core::view {
